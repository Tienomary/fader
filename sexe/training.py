...
autoencoder.load_state_dict(torch.load('train_sexe70epoch/autoencoder.pth'), strict=True) 
discriminator.load_state_dict(torch.load('train_sexe70epoch/discriminator.pth'), strict=True) 
