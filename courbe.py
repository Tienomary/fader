...
train_ae_loss_file = "vect_train_ae_loss.txt"
train_disc_loss_file = "vect_train_disc_loss.txt"
val_ae_loss_file = "vect_val_ae_loss.txt"
val_disc_loss_file = "vect_val_disc_loss.txt"
